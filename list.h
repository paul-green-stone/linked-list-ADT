...
extern List_t List_new(fptr_destroy destroy_func, fptr_print print_func, fptr_match match_func);
...
extern int8_t List_insert_first(List_t list, const Data data);

/* Insert a new element with specified data at the end of the linked list */
extern int8_t List_insert_last(List_t list, const Data data);
...
extern int8_t List_insert_after(List_t list, const Data data, const Node node);

/* Insert an element with the specified data before the node in the list */
extern int8_t List_insert_before(List_t list, const Data data, const Node node);
